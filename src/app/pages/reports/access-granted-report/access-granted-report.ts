...
@Component({
  selector: 'app-access-granted-report',
  imports: [CommonModule, SharedModule, FormsModule],
  templateUrl: './access-granted-report.html',
  styleUrl: './access-granted-report.scss',
})
export class AccessGrantedReport {
 locations = [];
...
if (Array.isArray(this.selectedLocationIds) && this.selectedLocationIds.length > 0 && this.selectedEmployeeId != null && this.selectedEmployeeId !== '') {
  ...
  // EMPLOYEE 
    ...
    apiUrl = 'accessGrantedReportEmpIdWise';
  ...
  //  date-based call
    ...
    apiUrl = 'accessGrantedReportDateWise';
  }
...
onExportPdf() {
  ...
  html2canvas(DATA, {
    ...
    pdf.save('Access Granted Report.pdf');
  });
}
}
